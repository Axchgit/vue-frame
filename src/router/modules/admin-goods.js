 ...
 * @LastEditTime: 2020-08-29 23:12:22
 * @LastEditors: xch
...
export default {
  ...
  children: (pre => [
    ...
    // { path: 'select/jd', name: `${pre}UpdateJd`, component: _import('admin/goods/select/jd'), meta: { ...meta, title: '推广订单查询-京东' }},
    // { path: 'select/tb', name: `${pre}UpdateTB`, component: _import('admin/goods/select/tb'), meta: { ...meta, title: '推广订单查询-淘宝' }},
    // { path: 'select/pdd', name: `${pre}UpdatePdd`, component: _import('admin/goods/select/pdd'), meta: { ...meta, title: '推广订单查询-拼多多' }}
